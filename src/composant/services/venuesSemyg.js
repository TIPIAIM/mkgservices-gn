...
export const VENUES = [
  ...
  },
  {
    ...
    type: "colonies de vacances",
    description: "Apprendre par le jeu : créativité, autonomie, socialisation.",
  },
  {
    label: "Colonie — Team",
    img: imagess?.colon6 || fallback,
    type: "colonies de vacances",
    description: "Jeux coopératifs et défis pour renforcer l’esprit d’équipe.",
  },
  {
  ...
  },
  {
    ...
    type: "colonies de vacances",
    description: "Soirées thématiques, feux de camp, souvenirs mémorables.",
  },
  ...
  },
  {
    ...
    type: "Family day",
    description: "Espaces lounge, coins calmes, zones repas conviviales.",
  },
  {
  ...
  },
  {
    ...
    type: "Family day",
    description: "Animations adaptées, jeux sécurisés, encadrement dédié.",
  },
  {
    label: "Family Day — Ludiques",
    img: imagess?.Pour_les_Family_day12 || fallback,
    type: "Family day",
    description: "Jeux géants, structures gonflables, photobooth souvenirs.",
  },
  {
  ...
  {
    label: "Espace Photo — 03",
    img: imagess?.AmenagementespacesPhotos1 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Photobooth, fonds variés et gestion des flux visiteurs.",
  },
  {
    label: "Espace Photo — 04",
    img: imagess?.AmenagementespacesPhotos2 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Décor modulable pour formats portrait/paysage.",
  },
  {
    label: "Espace Photo — 05",
    img: imagess?.AmenagementespacesPhotos3 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Set design pour prises de vues produits & personnes.",
  },
  {
    label: "Espace Photo — 06",
    img: imagess?.AmenagementespacesPhotos4 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Fonds créatifs, matières et textures originales.",
  },
  {
    label: "Espace Photo — 07",
    img: imagess?.AmenagementespacesPhotos5 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Lumière continue ou flash selon le rendu souhaité.",
  },
  {
    label: "Espace Photo — 08",
    img: imagess?.AmenagementespacesPhotos6 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Accès PMR et repères au sol pour files d’attente.",
  },
  {
    label: "Espace Photo — 09",
    img: imagess?.AmenagementespacesPhotos7 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Habillage brandé : kakemonos, arches, totems.",
  },
  {
    label: "Espace Photo — 10",
    img: imagess?.AmenagementespacesPhotos8 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Parcours visiteur intégré aux autres activités.",
  },
  {
    label: "Espace Photo — 11",
    img: imagess?.AmenagementespacesPhotos9 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Gestion électricité & sécurité, câblages discrets.",
  },
  {
    label: "Espace Photo — 12",
    img: imagess?.AmenagementespacesPhotos10 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Poste opérateur, flux photo, stockage rapide.",
  },
  {
    label: "Espace Photo — 13",
    img: imagess?.AmenagementespacesPhotos11 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Diffusion live possible (écran scène/stand).",
  },
  {
    label: "Espace Photo — 14",
    img: imagess?.AmenagementespacesPhotos12 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Backdrop premium, matières textiles & papier.",
  },
  {
    label: "Espace Photo — 15",
    img: imagess?.AmenagementespacesPhotos13 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Espace compact pour lieux contraints.",
  },
  {
    label: "Espace Photo — 16",
    img: imagess?.AmenagementespacesPhotos14 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Pose d’accessoires & rangement optimisé.",
  },
  {
    label: "Espace Photo — 17",
    img: imagess?.AmenagementespacesPhotos15 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Photocall officiel & tapis rouge.",
  },
  {
    label: "Espace Photo — 18",
    img: imagess?.AmenagementespacesPhotos16 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Éclairage coloré pour ambiance artistique.",
  },
  {
    label: "Espace Photo — 19",
    img: imagess?.AmenagementespacesPhotos17 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Circulation et balisage pour shootings fluides.",
  },
  {
    label: "Espace Photo — 20",
    img: imagess?.AmenagementespacesPhotos18 || fallback,
    type: "Amenagement d'espaces Photos",
    description: "Photo souvenir instantanée & partage digital.",
  },
  ...
  // Location jeux & attractions
  {
    ...
    description: "Location d’attractions et modules ludiques sécurisés.",
  },
  {
    label: "Attraction — 02",
    img: imagess?.LocationjeuxAttractions2 || fallback,
    type: "Location jeux et Attractions",
    description: "Jeux pour tous âges, animateurs formés et brief sécurité.",
  },
  {
    label: "Attraction — 03",
    img: imagess?.LocationjeuxAttractions3 || fallback,
    type: "Location jeux et Attractions",
    description: "Montage/démontage compris, assurance & contrôle.",
  },
  {
    label: "Attraction — 04",
    img: imagess?.LocationjeuxAttractions4 || fallback,
    type: "Location jeux et Attractions",
    description: "Catalogue élargi : sportifs, gonflables, adresse.",
  },

  {
    label: "Team building",
    img: imagess?.building21 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building20 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building19 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building18 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building17 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building16 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building15 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building14 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building13 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building12 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building11 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building10 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building1 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building2 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building3 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building4 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building5 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building6 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building7 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building8 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building9 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building22 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building23 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building24 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building25 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building26 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building27 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building28 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building29 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building30 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building31 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building32 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building33 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building34 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building35 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building36 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building37 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building38 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building39 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building40 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building41 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building42 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building43 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building44 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building45 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building46 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building47 || fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building48 | fallback,
    type: "Team Building",
    description: " ",
  },
  {
    label: "Team building",
    img: imagess?.building49 || fallback,
    type: "Team Building",
    description: " ",
  },
